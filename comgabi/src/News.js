        ...
        <article className="flex max-md:flex-col h-auto gap-6 p-6 mt-6">
            <div className="flex-1 p-6 border border-gray-300 rounded-lg">
                ...
                <div className="overflow-x-auto">
                    <table className="table">
                        ...
                        <tr>
                            <td>
                            <Link to="https://www.bbc.com/korean/articles/cwy9k9zz807o" className="flex items-center gap-4">
                                ...
                                alt="News_Photo" />
                                <div className="font-bold w-full max-md:w-auto text-xl">2024 미국 대선 개표 현황</div>
            ...
            <div className="p-6 border w-[30%] max-md:w-[100%] border-gray-300 rounded-lg">
                ...
                <div className="grid grid-rows-2 gap-6">
                    <iframe className="aspect-video w-[100%]" src="https://www.youtube.com/embed/NMjhjrBIrG8?si=nwbgH35T3h7gsYO5" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    <iframe className="aspect-video w-[100%]" src="https://www.youtube.com/embed/NMjhjrBIrG8?si=nwbgH35T3h7gsYO5" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </div>
            </div>
        </article>
